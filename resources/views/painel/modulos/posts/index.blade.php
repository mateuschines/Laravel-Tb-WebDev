    ...
    <table class="table table-striped">
        ...
        @forelse($datas as $cat)
            <tr>
                ...
                <td>{{$cat->status}}</td>
                <td>
                <a href="{{route('posts.show', $cat->id)}}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
                <a href="{{route('posts.edit', $cat->id)}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
